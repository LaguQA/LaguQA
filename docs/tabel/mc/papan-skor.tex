...
\centering
\small
\caption{Akurasi toleran (\%) pada LaguQA, jalur pilihan ganda.}
\begin{tabular}{lrrrrrr}
\toprule
\textbf{Model} & \textbf{Keseluruhan} & \textbf{Fakta} & \textbf{Tebak judul} & \textbf{Lirik} & \textbf{Notasi} & \textbf{Penalaran} \\
\midrule
\multicolumn{7}{c}{\textit{Kontrol (tidak mengenal satu lagu pun)}} \\
...
\midrule
\multicolumn{7}{c}{\textit{Model tanpa pelatihan}} \\
...
\midrule
\multicolumn{7}{c}{\textit{Hasil fine-tuning LaguQA}} \\
